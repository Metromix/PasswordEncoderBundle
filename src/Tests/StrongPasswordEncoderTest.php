...
use Metromix\PasswordEncoderBundle\Security\Encoder\StrongPasswordEncoder;

class StrongPasswordEncoderTest extends \PHPUnit_Framework_TestCase
{
    public function testLibsodiumEncode()
    {
        ...
        $encoder = new StrongPasswordEncoder(12, $globalSalt);
